...
1. **VisualClaimIntegrity** — one OpenAI vision call: is the damage physically plausible for the material, and does the image match the claim text. (The prompt lives in `signal-1-prompt.md` — do not rewrite it; import it.)
